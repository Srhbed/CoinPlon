    ...
    def clean(self):
        ...
        if self.internal_page and self.external_page:
            raise  ValidationError({
                "internal_page" : ValidationError("SVP , séléctionner un lien interne ou un lien externe "),
                "external_page" : ValidationError("SVP , séléctionner un lien interne ou un lien external ")
    ...
    def clean(self):
        ...
        if not self.internal_page and not self.external_page:
            raise  ValidationError({
                ...
                "external_page" : ValidationError("vous devez avoir au moins un lien interne ou un lien external ")
